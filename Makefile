...
#    Updated: 2025/03/02 15:51:35 by root             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c parsing.c execution.c builtins.c signal.c utils.c is_utils.c linked_list.c echo.c env.c env2.c expand.c
