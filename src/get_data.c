...
/*   Updated: 2025/03/07 21:07:39 by lmonsat          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* Version adapté de ta fonction parse_command() pour la liste chaînée
	Lis la commande étant dans le token_cmd et la ,
        compare avec le tableau builtin
	si la commande correspond celle ci est ensuite executé
	Pour chaque argument dans token_arg ils sont stocké,
         dans data qui est ensuite,
	donné comme char ** aux fonctions builtin */
/* cmd_execution() passe des tests classiques mais il y aura certainement,
 des changement a faire par la suite
